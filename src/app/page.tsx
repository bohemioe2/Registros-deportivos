      ...
      <main className="max-w-6xl mx-auto px-6 pb-32 relative z-10">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-2">
          {loading ? (
            ...
            >
              <div className={`${evt.eventBannerUrl ? 'h-auto min-h-[300px]' : 'aspect-[16/10]'} w-full overflow-hidden rounded-[40px] relative bg-[#171821] flex items-center justify-center`}>
                 <img 
